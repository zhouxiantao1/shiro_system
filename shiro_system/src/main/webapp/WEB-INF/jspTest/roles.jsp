...
<body class=" theme-blue">
    ...
    <ul>
    <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i> 系统管理<i class="fa fa-collapse"></i></a></li>
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="${pageContext.request.contextPath}/"><span class="fa fa-caret-right"></span>主菜单</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/user/list"><span class="fa fa-caret-right"></span> 用户列表</a></li>
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <footer>
                ...
                <p class="pull-right">Collect from <a href="http://www.cssmoban.com/" title="系统管理" target="_blank">系统管理</a></p>

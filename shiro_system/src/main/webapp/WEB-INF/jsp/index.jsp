...
<script src="${pageContext.request.contextPath}/static/lib/jQuery-Knob/js/jquery.knob.js" type="text/javascript"></script>
		...
		<ul>
			...
			<li data-popover="true" data-content="Items in this group require a <strong><a href='http://portnine.com/bootstrap-themes/aircraft' target='blank'>premium license</a><strong>."
				...
				data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i>
					Premium Features<i class="fa fa-collapse"></i></a>
			</li>
			<li>
	...
	<div class="content">
		...
		<div class="main-content">
				...
				<div class="col-sm-6 col-md-6">
					<div class="panel panel-default">
						...
						<div id="widget2container" class="panel-body collapse in">
							...
							<p>
								<a class="btn btn-primary">Learn more Â»</a>
							</p>
						</div>
					</div>
				</div>
			...
			<footer>
				<hr>
				<p class="pull-right">
					Collect from <a href="http://www.cssmoban.com/" title="系统管理" target="_blank">系统管理</a>
				</p>
				<p>

    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
	      <form id="tab">
		        ...
		        <div class="form-group">
			        <label>权限标识</label>
			        <input type="text" placeholder="例如：sys:user:list" id="permission" class="form-control">
		        </div>
		         <div class="form-group">
		            <label>是否可用</label>
				...
				<div class="form-group" hidden="hidden">
			        <label>父类id</label>
			        <input type="text"  id="parentId" value="${permission.parentId}" class="form-control">
		        </div>
		        <div class="form-group" hidden="hidden">
			        <label>status</label>
			        <input type="text" value="${status}" id="status" class="form-control">
		        </div>
	        </form>
      </div>
	</div>

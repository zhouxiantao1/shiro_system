...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			...
			<h1 class="page-title">新增${catalog}</h1>
			<ul class="breadcrumb">
	...
	<script type="text/javascript">
	 $(".cancel_storyPerson").click(function(){
		 window.location.href="${r'${pageContext.request.contextPath}'}/storyPerson/toList";
        ...
        $("#save_storyPerson").click(function(){
        	$.ajax({
        		...
        		url:"${r'${pageContext.request.contextPath}'}/storyPerson/add",
